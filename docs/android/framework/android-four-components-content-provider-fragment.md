...
!!! tip
    `ContentProvider.onCreate`的执行要在`Application.onCreate`之前，详细可以查看[ContentProvider的工作过程](/android/framework/four-components-startup-process/#5-contentprovider)
