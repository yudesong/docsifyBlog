...
关于动画的详细内容会在[Android动画](/android/framework/android-animation/)中讲解。
...
这点可以从Android 7.0以后的代码上直接看出来，具体在Activity类的[attach](http://androidxref.com/7.1.1_r6/xref/frameworks/base/core/java/android/app/Activity.java#6619)方法中`mWindow = new PhoneWindow(this, window);`。[更多关于Window的知识可以查看此文章](/android/framework/window-and-windowmanager/)
