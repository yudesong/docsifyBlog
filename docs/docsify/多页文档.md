...
首先配置 `loadSidebar` 选项，具体配置规则见[配置项#loadSidebar](#/zh-cn/configuration?id=loadsidebar)。
...
自定义侧边栏同时也可以开启目录功能。设置 `subMaxLevel` 配置项，具体介绍见 [配置项#subMaxLevel](#/zh-cn/configuration?id=submaxlevel)。
