...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/de5a5aa7b3ad4d08a36a6d91223cd75b~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
```html
arduino 体验AI代码助手 代码解读复制代码 Stream<String>
  stream = new Stream<String
    >.fromIterable(['不开心', '面试', '没', '过']); main() async{ await
    for(String s in stream){ print(s); } }
  </String></String
>
```
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7da3176245374660b467a5f83727724f~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ecebe8ec5063430dbed49286f2735e81~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
**如果这篇文章对你有帮助，那就点个赞收藏一下吧！**

## 关注微信公众号：Android老皮 获得最新Android咨询
