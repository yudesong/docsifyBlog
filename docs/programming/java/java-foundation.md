...
——<cite>[Android IPC简介](/android/framework/ipc-mechanism/#1-android-ipc)</cite>
...
当然，现在androidx当道的年代，这种方式已经不适用了，androidx里面的`BottomNavigationView`可定制性更好，详情可以参考[Material库中的BNV](/android/other/android-bottom-navigation-framework/#3-materialbnv)
...
<cite>进程保活——进程优先级</cite>

---

**[IPC机制](/android/framework/ipc-mechanism/)**
